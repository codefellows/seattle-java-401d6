...
import com.ferreirae.songr.models.Reason;
import com.ferreirae.songr.models.ReasonRepository;
...
//        };
    ...
    public RedirectView deleteTheEmotion(long id){
        emotionRepository.deleteById(id);
        return new RedirectView("/emotions");
    }

    @PostMapping("/reasons")
    public RedirectView addReason(long id, String reason){
        Emotion e = emotionRepository.getOne(id);
        Reason r = new Reason(reason);
        r.setEmotion(e);
